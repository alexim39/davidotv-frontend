          ...
          <div class="price-section">
            @if (data.discountPrice) {
              <div class="discount-price">
                <span class="original-price">{{data.price | currency}}</span>
                <span class="current-price">{{data.discountPrice | currency}}</span>
                @if (data.discountPercent) {
                  <span class="discount-percent">-{{data.discountPercent}}%</span>
                }
              </div>
            } @else {
          ...
          <div class="product-meta">
            ...
            @if (data.rating) {
              <div class="rating">
                ...
                <span>{{data.rating}} ({{data.reviews || 0}} reviews)</span>
              </div>
            }
          </div>
...
export class QuickViewComponent implements OnInit {
  ...
  addToCart(): void {
    ...
    console.log('Added to cart:', this.data.name);
